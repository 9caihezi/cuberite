...
void cPlayer::UseEquippedItem(short a_Damage, eHand a_Hand)
{
	...
	if (GetInventory().DamageEquippedItem(a_Damage, a_Hand))
	{
...
void cPlayer::UseEquippedItem(cItemHandler::eDurabilityLostAction a_Action, eHand a_Hand)
{
	// Get item being used:
	cItem Item = GetEquippedItem(a_Hand);
